...
class Ld extends TagLib
{
    ...
    public function tagNav($tag, $content)
    {
        ...
        $parse .=  '<?php $'.$alias.'["image"]=cdnurl($'.$alias.'["image"],true);?>';
        $parse .=  '<?php $'.$alias.'["big_image"]=cdnurl($'.$alias.'["big_image"],true);?>';
        $parse .= $content;
        $parse .= '{/volist}';
...
eof;
        ...
        $params[] = "'filterWhere'=>isset(\$filterWhere)&&(\$is_filter)?\$filterWhere:[]";
