...
class Ldcms extends Addons
{
    ...
    public function install()
    {
        ...
        /*template*/
        $views = ['default','en','ldcms2024','ldcms2024en','ldcms2025','ldcms2025en'];
    ...
    protected function updateMenu()
    {
            ...
            $createMenu = [
                [
                    ...
                    'sublist' => [
                        ...
                        ['name' => 'ldcms/tagaction/copy', 'title' => '复制'],
        ...
        // 1.3.3
        $ids = LdcmsMenu::getAuthRuleIdsByName('ldcms/tagaction/copy');
        if (empty($ids)) {
            LdcmsMenu::create([
                ['name' => 'ldcms/tagaction/copy','title' => '复制']
            ], 'ldcms/tagaction');
        ...
        //1.4.0
        $ids = LdcmsMenu::getAuthRuleIdsByName('ldcms/models/copy');
        if (empty($ids)) {
            LdcmsMenu::create([
                ['name' => 'ldcms/models/copy','title' => '复制模型']
            ], 'ldcms/models');
        }
    }
}
